        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <q-td key="sequenceType" :props="props">
              <span>{{  seqTypeFormat(props.row.sequenceType) }}</span>
            </q-td>
            ...
            <q-td key="createdDate" :props="props">
              <span>{{  dateFormat(props.row.createdDate) }}</span>
            </q-td>
            <q-td key="lastModifiedDate" :props="props">
              <span>{{  dateFormat(props.row.lastModifiedDate) }}</span>
            </q-td>
          </q-tr>
        </template>
      </q-table>
...
<script>
// import { metadataSequenceService } from "stores/metadataSequenceService";
